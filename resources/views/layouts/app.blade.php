    ...
    <style>
        ...
        @media (min-width: 992px) {
            .sidebar {
                ...
                top: 0;
                overflow-y: auto;
                /* Agar sidebar bisa di-scroll jika menu panjang */
            }
...
<body>
    ...
    <div class="d-flex flex-column flex-lg-row min-vh-100">
        ...
        <div class="offcanvas-lg offcanvas-start bg-dark text-white sidebar d-flex flex-column p-3" tabindex="-1"
            id="sidebarMenu" aria-labelledby="sidebarMenuLabel">

            <div
                class="d-flex align-items-center justify-content-between mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="{{ route('admin.manajemen-user') }}"
                        class="nav-link text-white {{ request()->routeIs('admin.manajemen-user') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('admin.design.index') }}"
                        class="nav-link text-white {{ request()->routeIs('admin.design.index') ? 'active' : '' }}">
