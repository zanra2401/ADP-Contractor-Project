            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transition hover:shadow-xl">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('pelanggan.galeri') }}" class="w-full text-center block py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                Lihat Galeri Hasil
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden border-2 border-dashed border-gray-300 flex flex-col justify-center items-center p-6 min-h-[400px] hover:border-blue-400 transition cursor-pointer" onclick="openModal()">
                    <div class="text-center">
                        ...
                        <button type="button" class="mt-6 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                            Buat Proyek
                        </button>
                    </div>
                </div>
