                    ...
                    <div class="flex-1 p-6 space-y-4 overflow-y-auto bg-gray-50">
                        ...
                        <div class="flex justify-end">
                            <div class="bg-blue-600 text-white p-3 rounded-lg rounded-tr-none max-w-xs shadow-md">
                                ...
                                <span class="text-xs text-blue-100 block text-right mt-1">09:15</span>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            <div class="bg-white border border-gray-200 text-gray-800 p-3 rounded-lg rounded-tl-none max-w-xs shadow-sm">
                                ...
                                <span class="text-xs text-gray-400 block text-right mt-1">09:16</span>
                            </div>
                        </div>
                        ...
                        <!-- Chat Saya (Kanan) -->
                         <div class="flex justify-end">
                             <div class="bg-blue-600 text-white p-3 rounded-lg rounded-tr-none max-w-xs shadow-md">
                                ...
                                <span class="text-xs text-blue-100 block text-right mt-1">09:17</span>
                            </div>
                        </div>
                    </div>
